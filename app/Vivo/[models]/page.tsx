...
import { vivodata } from '@/app/database/vivo';
...
const Page =  ({params}:any) => {
 ...
 const  {models}= params
 const getarry=  vivodata.filter((val)=>val.id==models
 )
...
<div className='   py-10 px-10 border border-red-700  mt-[65px]'  >
 <div className=' py-10 px-10 md:flex justify-center gap-[20px]  bg-red-700  '>
  <div className='border border-red-700 bg-red-700 rounded-2xl'>
 ...
 */}
    ...
    <h1  className='uppercase  font-light tracking-[-0.1rem] flex   pt-3 hover: text-red-600 ' ><span className='flex   font-bold  gap-2'><MdSdStorage className='hover:text-3xl ' />Storage</span> {getarry?.[0]?.storage}</h1>
