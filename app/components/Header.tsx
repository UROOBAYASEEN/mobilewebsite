  ...
  return (
    <div className='bg-white text-black tracking-tighter overflow-x-hidden flex justify-between px-10 py-5 fixed top-0 left-0 right-0'>
      ...
      <div className='flex justify-evenly gap-5'>
        {headerdata.map((val)=><Link href={val.route}><h3 className='font-[500] tracking-tighter uppercase pb-3  hover:underline  hover:decoration-6 hover:underline-offset-4'>{val.name}</h3></Link>)}
      </div>
